...
const Title = () => {
  ...
  return (
    <textarea
      ...
      className="origin-left animate-fade-in-standard resize-none overflow-hidden rounded-sm bg-transparent px-3 py-1 text-xl font-medium outline-none transition-shadow"
